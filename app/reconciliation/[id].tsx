            ...
            >
                ...
                <View style={styles.emptyContainer}>
                    <Text style={styles.emptyText}>
                        {loadError || "Reconciliation not found"}
                    </Text>
                    {loadError && (
                        <TouchableOpacity
                            style={{
                ...
                >
                    ...
                    {reconciliation.cashier && (
                        <Text style={styles.cashierName}>
                            Reconciled by {reconciliation.cashier.name}
                        </Text>
                    )}
                </View>
                    ...
                    <View style={styles.summaryGrid}>
                        <View style={styles.summaryCard}>
                            ...
                            <Text style={styles.summaryValue}>
                                ₱{reconciliation.expected_cash.toLocaleString()}
                            </Text>
                        </View>
                        <View style={styles.summaryCard}>
                            <View style={styles.summaryIconContainer}>
                            ...
                            <Text style={styles.summaryValue}>
                                ₱{reconciliation.actual_cash.toLocaleString()}
                            </Text>
                        </View>
                    </View>
