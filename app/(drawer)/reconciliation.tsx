...
export default function ReconciliationScreen() {
    ...
    const handleApproveCorrection = (item: Reconciliation) => {
        setConfirmDialog({
            ...
            message: `Approve correction request for ${
            ...
            <View style={styles.cardHeader}>
                <View style={styles.dateContainer}>
                    <Text style={styles.date}>
                        {new Date(item.reconciliation_date).toLocaleDateString(
                            "en-US",
                            {
                                month: "short",
                                day: "numeric",
            ...
            <View style={styles.amountsRow}>
                <View style={styles.amountCol}>
                    ...
                    <Text style={styles.amountValue}>
                        ₱{item.expected_cash.toLocaleString()}
                    </Text>
                </View>
                <View style={styles.amountCol}>
                    <View style={styles.amountLabelRow}>
                    ...
                    <Text style={styles.amountValue}>
                        ₱{item.actual_cash.toLocaleString()}
                    </Text>
                </View>
            </View>
